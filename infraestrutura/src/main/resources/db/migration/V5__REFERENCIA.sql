...
-- =====================================================================
-- MÓDULO: REFERÊNCIA - ESPECIALIDADES
-- Descrição: Tabelas para gerenciamento de especialidades médicas
-- =====================================================================

-- Tabela principal: especialidades
CREATE TABLE especialidades (
    id INT AUTO_INCREMENT PRIMARY KEY,
    nome VARCHAR(100) NOT NULL UNIQUE,
    descricao VARCHAR(255),
    status VARCHAR(20) NOT NULL,
    possui_vinculo_historico BOOLEAN NOT NULL DEFAULT FALSE,
    
    CONSTRAINT chk_especialidades_status CHECK (status IN ('ATIVA', 'INATIVA'))
);

-- Tabela de histórico: historico_especialidades
CREATE TABLE historico_especialidades (
    id INT AUTO_INCREMENT PRIMARY KEY,
    ...
    CONSTRAINT fk_historico_especialidade FOREIGN KEY (especialidade_id) 
...
CREATE INDEX idx_especialidades_status ON especialidades(status);
CREATE INDEX idx_historico_especialidade_id ON historico_especialidades(especialidade_id);