Feature: Gerenciamento de Especialidades Médicas
  ...
  Scenario: [RN 1.1 - Falha] Tentativa de cadastro com nome vazio
  ...
  Scenario: [RN 1.2 - Sucesso] Cadastro com nome único (implicitamente testado no 1.1)
  ...
  Scenario: [RN 1.2 - Falha] Tentativa de cadastro com nome duplicado
  ...
  Scenario: [RN 1.3 - Sucesso] Cadastro com nome alfabético válido
    When o administrador solicitar o cadastro de especialidade com nome "Otorrinolaringologia e Cabeça e Pescoço"
    Then o sistema deve cadastrar a especialidade com sucesso

  Scenario: [RN 1.3 - Falha] Tentativa de cadastro com caracteres não alfabéticos
  ...
  Scenario: [RN 1.4 - Sucesso] Cadastro com descrição dentro do limite de 255 caracteres
  ...
  Scenario: [RN 1.4 - Falha] Tentativa de cadastro com descrição excedendo 255 caracteres
  ...
  Scenario: [RN 1.5 - Sucesso] Verificação do status inicial após cadastro
  ...
  Scenario: [RN 1.5 - Falha] Tentativa de cadastrar forçando o status como "Inativa"
  ...
  Scenario: [RN 2.1 - Sucesso] Alteração permitida de nome e descrição
  ...
  Scenario: [RN 2.1 - Falha] Tentativa de alterar campos não permitidos
  ...
  Scenario: [RN 2.2 - Sucesso] Alteração de nome para um nome válido e único
  ...
  Scenario: [RN 2.2 - Falha] Alteração de nome para um nome duplicado
    Given que a especialidade "Geral" está cadastrada
  ...
  Scenario: [RN 2.3 - Sucesso] Alteração de nome com tratamento bem-sucedido
  ...
  Scenario: [RN 2.3 - Falha] Tentativa de alteração de nome sem tratamento da vinculação
  ...
  Scenario: [RN 3.1 - Sucesso] Exclusão de especialidade sem médicos ativos vinculados
  ...
  Scenario: [RN 3.1 - Falha] Tentativa de exclusão com médicos ativos vinculados
  ...
  Scenario: [RN 3.2 - Sucesso] Exclusão física por nunca ter tido vínculo
  ...
  Scenario: [RN 3.2 - Falha] Tentativa de exclusão física onde houve histórico de vínculo
  ...
  Scenario: [RN 3.3 - Sucesso] Inativação em vez de exclusão devido a histórico
    Given que a especialidade "Gastroenterologia" possui histórico de vínculo com médicos
  ...
  Scenario: [RN 3.3 - Falha] Tentativa de inativar especialidade sem histórico
    Given que a especialidade "Fisioterapia" nunca foi vinculada a um médico
  ...
  Scenario: [RN 3.4 - Sucesso] Atribuição de médico a especialidade Ativa
  ...
  Scenario: [RN 3.4 - Falha] Tentativa de atribuir médico a especialidade Inativa
